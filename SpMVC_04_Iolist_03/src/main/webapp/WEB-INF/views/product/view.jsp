...
$(function(){
	...
	$(".btn-delete").click(function(){
		...
		if(confirm(msg)) {
			document.location.href = "${rootPath}/product/delete?p_code=${PRO_DTO.p_code}"			
		}
...
<section>
	<table>
		...
		<tr>
			<th>매입가격</th><td>${PRO_DTO.p_iprice}</td>
			<th>판매가격</th><td>${PRO_DTO.p_oprice}</td>
		</tr>
		<tr>
			<th>부가가치세</th><td colspan="3">${PRO_DTO.p_vat}</td>
		</tr>
		<tr>
			<td colspan="4">
				<div class="btn-box">
