...
<article class="mt-5 row">
	<article class="col-md-7 col-12 bg-light pro-input">
		...
		<form:form action="${rootPath}/admin/dept/input"
			...
			<div class="form-group">
				<form:input path="d_ceo" class="form-control" placeholder="대표이름" />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<form:input path="d_tel" class="form-control" placeholder="거래처 전화번호" />
			</div>
			<div class="form-group">
				<form:input path="d_addr" class="form-control" placeholder="거래처 주소" />
			</div>
			<div class="form-group">
				<form:input path="d_manager" class="form-control" placeholder="담당자 이름" />
			</div>
			<div class="form-group">
				<form:input path="d_mtel" class="form-control" placeholder="담당자 전화번호" />
			</div>
			<div class="form-group">
				<form:input path="d_tel" class="form-control" placeholder="거래처 전화번호" />
			</div>
			<div class="form-group">
				<form:textarea path="d_rem" 
					class="form-control" rows="" cols="" placeholder="비고"/>
			</div>
			<div class="form-group">
				<button>저장</button>
			</div>
