...
/*
html에서 div box에 image를 2개 가져와서 보이게 한다
초기에는 2번째 이미지를 감춰둔다(last-child display: none)

마우스가 올라가면(hover) 두번째 이미지는 보이게하고, 첫번째 이미지는 감춘다
 */
.naver_login img {
	border-radius: 10px;
}
...
<script>
$(function(){
	$(".naver_login").click(function(){ // div가 클릭되면 rootPath/member/naver로 페이지 이동 
	...
	<form method="POST" action="${rootPath}/member/login" class="login-form">
		...
		<input type="password" id="u_id" name="u_password" placeholder="비밀번호">
