...
<script>
	$(function(){ // jq 시작 알림
		// 겉보기는 똑같지만 실행하고 뒤로가기를 했을 때 나타나는 페이지가 다르다. history 문제
		$("#btn-update").on("click", function(){
			/*
			새 페이지를 만들어 지금 페이지 위에 겹쳐서 보이는게 href. 뒤로가기를 누르면 기존 페이지로 돌아가기
			*/
			document.location.href = "${rootPath}/iolist/update?id=${IO_DTO.io_seq}"
		})
		$("#btn-delete").click(function(){
			/*
			현재 페이지를 지우고 새로운 페이지로 다시 메우는 replace. 뒤로가기를 누르면 엉뚱한(history에 저장된) 페이지로
			*/
...
<body>
	...
	<br><br>
	<!-- a tag를 button처럼 쓰게
	href = javasciprt:void(0)은 a를 눌렀을 때 아무런 반응도 없게. dummy code -->
	<div class="btn-box">
