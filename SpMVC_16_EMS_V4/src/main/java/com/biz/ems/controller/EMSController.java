...
//		xMailService.sendMail(emailVO);
	...
	@ResponseBody
	@RequestMapping(value="/update/{ems}", method=RequestMethod.GET)
	public EmailVO update(@PathVariable("ems") String ems_seq) {
		return mailService.findBySeq(Long.valueOf(ems_seq));
	}
